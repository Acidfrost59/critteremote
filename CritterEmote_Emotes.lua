...
--The emote table was rewritten at version 1.14 WOW version 8.0.5
...
Random = {
  ...
  default_Locations = {
		...
		"wonders why anyone would visit a place called 'Stranglethorn'.",
		...
		"thinks suntan lotion would be a must in the Burning Steppes.",
		...
		"would like to time travel and visit the Night Elves in Teldrassil.",
		...
		"Would like to see the scar from Deathwing in the Southern Barrens.",
		...
		"thinks Icecrown is a cool but scary place.",
		"needs a coat to visit Wintergrasp.",
		"heard that Karazhan is a very tangled and mixed up place to visit.",
        ...
        "wonders if Argus will ever be rid of the Legion. Maybe now!",
...
-- Special thanks to Warcraftpets.com for pet updates. These have more to do with nature then with pet categories.
